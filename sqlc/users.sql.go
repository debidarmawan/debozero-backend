...
SELECT id, email, password, created_at, updated_at FROM users ORDER BY id LIMIT $1 OFFSET $2
`
...
UPDATE users SET password = $1, updated_at = $2 WHERE id = $3 RETURNING id, email, password, created_at, updated_at
`
